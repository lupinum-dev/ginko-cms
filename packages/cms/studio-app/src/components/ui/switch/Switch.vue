...
<template>
  <SwitchRoot
    ...
    :class="
      cn(
        'ginko:peer ginko:inline-flex ginko:h-5 ginko:w-9 ginko:shrink-0 ginko:cursor-pointer ginko:items-center ginko:rounded-full ginko:border ginko:border-transparent ginko:transition-colors ginko:focus-visible:outline-none ginko:focus-visible:ring-[3px] ginko:focus-visible:ring-ring/50 ginko:aria-invalid:border-destructive ginko:aria-invalid:ring-destructive/20 ginko:dark:aria-invalid:ring-destructive/40 ginko:disabled:cursor-not-allowed ginko:disabled:opacity-50 ginko:data-[state=checked]:bg-primary ginko:data-[state=unchecked]:bg-input',
        props.class,
      )
    "
  >
