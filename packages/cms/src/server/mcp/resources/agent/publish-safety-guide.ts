    ...
    contents: [
      {
        ...
        text: [
          ...
          '',
          'Rerun the preview if arguments, draft state, or target state changed before requesting a new human review.',
          '',
          ...
          '',
          'Production MCP calls use Better Auth API-key sessions for Convex transport. MCP tools use explicit CMS Convex component refs for reads, draft edits, publish previews, and human review requests only.',
        ].join('\n'),
      },
    ],
  }),
