    ...
    contents: [
      {
        ...
        text: [
          ...
          '',
          'Before requesting publication of a localized route, inspect collection mode, localized required fields, parent route state, route collisions, and public visibility diagnostics.',
          '',
          'For translation prep, compare source and target locale data, check whether the target locale draft exists, inspect missing required fields and route blockers, and use `get-readiness-detail` as readiness context before requesting human review.',
          '',
