 ...
 *
 * Source: ginko-content/packages/content/src/cms-contract/mdc.ts
 *
...
import { mapMarkdownNodes, toMarkdownRoot } from './markdownTree.js'
import type { MarkdownNode, MarkdownRoot, Toc } from './types.js'
