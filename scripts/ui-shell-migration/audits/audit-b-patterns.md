...
### Native `<select>` (Select primitive is canonical — used in [collection]/index, settings/*, fields/FieldSelect, editor/*)
...
Note: computed *tone-class helpers* on status rows/cards/pills (`pages/index.vue:438`, `pages/[collection]/index.vue:489-491,708-709,796-797`, `editor/StudioEntryTrackCard.vue:151-155`, `editor/StudioLocaleEditorPanel.vue:42`, `dashboard/StudioDashboardWorkflowPath.vue:24-26`, `StudioAssetBrowser.vue:1580-1581,1873-1874`) are semantic state-tints on rows/cards, a distinct pattern from notice boxes — **not** flagged as StudioNotice candidates, but see §5 for their opacity drift.
